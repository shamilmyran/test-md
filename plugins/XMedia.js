...
command({
  ...
  async (message, match, m) => {
    ...
    ffmpeg(location)
      ...
      .save("output.mp4")
      .on("end", async () => {
        await message.sendMessage(fs.readFileSync("output.mp4"), {caption: "_Media From Alien-Alfa"}, "video");
      });
  }
);
...
command({
  ...
  async (message, match, m) => {
    ...
    ffmpeg(location)
      ...
      .save("output.mp3")
      .on("end", async () => {
        await message.sendMessage(fs.readFileSync("output.mp3"), {caption: "_Media From Alien-Alfa"}, "audio");
      });
  }
);
...
command({
  ...
  async (message, match, m) => {
    ...
    ffmpeg(location)
      ...
      .save("output.jpg")
      .on("end", async () => {
        await message.sendMessage(fs.readFileSync("output.jpg"), {caption: "_Media From Alien-Alfa"}, "image");
      });
  }
);
...
command({
  ...
  async (message, match, m) => {
    ...
    ffmpeg(location)
      ...
      .save("slowmo.mp4")
      .on("end", async () => {
        await message.sendMessage(fs.readFileSync("slowmo.mp4"), {caption: "_Media From Alien-Alfa"}, "video");
      });
  }
);
