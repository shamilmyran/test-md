...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID === undefined ?  req.config.SESSION_ID: process.env.SESSION_ID,
  LANG: req.config.LANG  === "" ? "EN" :  req.config.LANG,
  HANDLERS: req.config.HANDLER === "false" || req.config.HANDLER === undefined || req.config.HANDLER === "" ? "^" : req.config.HANDLER,
  ...
  SUDO: req.config.SUDO  === "" ? process.env.SUDO :  req.config.SUDO,
